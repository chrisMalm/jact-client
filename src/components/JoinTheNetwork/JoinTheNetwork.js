...
export const JoinTheNetwork = () => {
 ...
 our walls there is experiences from players, leaders and the role as deciding over elite clubs, both nationally and internationally. We come from working in the elite stage from the highest ranked leagues in the floorballworld, as well as international championships.
