  ...
  return (
    <div id='lectures' className={classes.wrapperBookUs}>
      ...
      <div className={classes.bookUsText}>
        ...
        <div>
        <b>
          After getting emails&nbsp;
          </b>
           from different people from clubs and Floorball schools
        ...
        <b>
        So we have now&nbsp;
          </b> a sculptured presentation for the ones who needs/wants us
        ...
        that the more people we can reach out to and give the 360 angel
        ...
        So are you&nbsp;
         ...
         as a club or a school interesting in this string in JACT,
