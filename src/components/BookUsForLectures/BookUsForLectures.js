		...
		<div id='lectures' className={classes.wrapperBookUs}>
			...
			<div className={classes.bookUsText}>
				...
				<div>
					...
					from different people from clubs and Floorball schools asking us if we
					could come to them and have lectures about what we do and how we do
					it, we think it’s great signals that we doing things right.<br></br>
					<b>So we have now&nbsp;</b> a sculptured presentation for the ones who
					needs/wants us to give them a behind the scenes picture of a
					...
					perspective of the complexity with a contract, transfer and the things
					you need to do to make everybody happy - the more we help our sport to
					reach the place we want to come to.<br></br>
					<b>So are you&nbsp;</b>
